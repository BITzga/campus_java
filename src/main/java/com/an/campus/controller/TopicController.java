...
//    }
    ...
    public QResult<Topic> comment(@PathVariable BigInteger id,@RequestBody @Validated Comment newCommend){
    ...
    public QResult<Topic> comment(@PathVariable BigInteger id,@PathVariable @Validated BigInteger commandId,@RequestBody  Comment newCommend){
